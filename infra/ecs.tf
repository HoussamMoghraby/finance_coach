...
resource "aws_secretsmanager_secret" "app_secrets" {
  ...
  description             = "Application secrets for Financial Coach"
  ...
  container_definitions = jsonencode([
    {
      ...
      secrets = [
        {
          name      = "DATABASE_URL"
          valueFrom = "${aws_secretsmanager_secret.db_credentials.arn}:dbConnectionString::"
        },
        {
          name      = "SECRET_KEY"
...
# Update Secrets Manager to include connection string format
resource "aws_secretsmanager_secret_version" "db_credentials_updated" {
  ...
  secret_string = jsonencode({
    ...
    dbConnectionString = "postgresql://${var.db_username}:${var.db_password}@${aws_db_instance.postgres.endpoint}/${aws_db_instance.postgres.db_name}"
  })
